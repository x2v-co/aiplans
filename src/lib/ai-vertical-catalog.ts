...
export const AI_VERTICAL_CATALOG: AiCatalogItem[] = [
  ...
  },
  {
    ...
    provider: 'SkyReels',
    status: 'available',
    pricing: 'Credits / subscription; official UI exposes credit units by model mode.',
    unit: 'credits, generations',
    capabilities: ['text-to-video', 'image-to-video', 'video extension', 'omni video'],
    bestFor: 'SkyReels web video generation workflows across text, image and reference-video modes.',
    modelCategory: 'video',
    inputModalities: ['text', 'image', 'video'],
    outputModalities: ['video'],
    access: ['consumer-app'],
    ...
    pricingConfidence: 'unit-only',
    sourceUrls: [
      { label: 'SkyReels', url: 'https://skyreels.ai/', publisher: 'SkyReels' },
      { label: 'SkyReels pricing', url: 'https://skyreels.ai/pricing', publisher: 'SkyReels' },
    ],
    lastVerified: VERIFIED_AT,
    notes: 'Official SkyReels app bundle exposes skyreels-v4 text/image/omni/video model modes and T2V/I2V/video-extension credit rate tables. Numeric pricing is intentionally not copied until a stable official pricing page can be audited.',
  },
  ...
  },
  {
    ...
    pricing: 'Subscription / credits',
    unit: 'credits, songs',
    capabilities: ['music generation', 'vocals', 'lyrics', 'instrumentals'],
    bestFor: 'Full song generation with vocals, lyrics and instrumentals from text prompts.',
    modelCategory: 'music',
    inputModalities: ['text', 'audio'],
    outputModalities: ['music', 'audio'],
    access: ['consumer-app'],
    ...
    pricingConfidence: 'unit-only',
    sourceUrls: [
      { label: 'Mureka AI music generator', url: 'https://www.mureka.ai/create', publisher: 'Mureka' },
      { label: 'Mureka subscription page', url: 'https://www.mureka.ai/subscribe', publisher: 'Mureka' },
    ],
    lastVerified: VERIFIED_AT,
  },
  {
