...
/**
 * The interactive half of /coupons: the copy-to-clipboard buttons.
 *
 * `coupons` used to be fetched in an effect, so the server rendered the
 * `loading` branch and crawlers got 32 characters and a spinner.
 */
      ...
      <main className="container mx-auto px-4 py-8">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            {!coupon.is_verified && (
                              <Badge variant="outline" className="text-xs">{t('unverified')}</Badge>
                            )}
                          </div>
                          <p className="text-sm text-zinc-500">{coupon.description}</p>
                        </div>
        ...
        <Card className="mt-12 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/30 dark:to-purple-950/30">
          <CardContent className="py-8 text-center">
            <h3 className="font-bold text-xl mb-2">{t('haveCoupon')}</h3>
